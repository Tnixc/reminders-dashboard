...
func (r *Reminder) renderList(isSelected bool) string {
	...
	return badgeStyle.Render(r.Data.List)
}
...
func (r *Reminder) renderSelection(isSelected bool) string {
	if isSelected {
		return lipgloss.NewStyle().
			Foreground(r.Ctx.Theme.SelectedBackground).
			Render("┃")
	}
	return " "
}
